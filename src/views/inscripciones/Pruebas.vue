<template>
  <div>
    ...
    <div v-if="showModal" class="bg-black overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none justify-center items-center flex">
